namespace ProductRecommenderModel
{
    using Microsoft.ML;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (needTrain)
            {
                ...
                //STEP 3: Read the training data which will be used to train the product recommendation model
                var traindata = reader.Read(new MultiFileSource(TrainingDataLocation));

                //STEP 4: Data is already encoded so all you need to do is call the MatrixFactorization Trainer with a few extra hyperparameters
            ...
            //// TEST MODEL
            ////STEP 7: Create prediction engine and predict the score for Product 45 being co-purchased with Product 4.
